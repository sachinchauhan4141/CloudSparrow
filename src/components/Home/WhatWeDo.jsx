...
const WhatWeDo = () => {
  return (
    <div className="px-6 md:px-10 pt-18">
      {/* Section Header */}
      <div className="flex items-center mt-[20px]">
        <img
          ...
          className="w-[20px] md:w-auto"
        />
        <p className="ml-3 text-[#2A6BFD] font-bold text-sm md:text-base">
          WHAT WE DO
        </p>
      </div>

      {/* Title */}
      <p className="mt-4 max-w-[90%] md:max-w-[70%] text-2xl md:text-6xl font-bold leading-tight">
        WE AIM FOR 100% CUSTOMER SATISFACTION
      </p>
...
const Card = ({ logo, img, title, description, tags }) => {
  return (
    <div className="flex flex-col bg-black w-full md:w-[460px] h-auto p-6 md:p-8 rounded-lg shadow-lg text-white">
      {/* Card Header */}
      <div className="flex justify-between items-start">
        <div className="flex justify-center items-center w-10 h-10 rounded-full bg-white">
          <img src={logo} alt="Logo" className="w-6 h-6" />
        ...
        <img
          src={img}
          alt="N/A"
          className="rounded-md object-cover w-[120px] md:w-[240px] h-[100px] md:h-[150px]"
        />
      </div>
      ...
      <div className="flex justify-between items-center mt-4 gap-4">
        ...
        <IoIosArrowDroprightCircle className="text-3xl md:text-4xl bg-[#FFFFFF] text-black rounded-full" />
      </div>
      <p className="text-sm mt-4">{description}</p>
